            ...
            <div style="<?= $this->template_styling( '', '', '', 'z_index' ) ?>" id="agy-my-modal" class="agy-modal">
                <div style="<?= $this->template_styling( '', '', 'background_color', '', 'box_width' ) ?>"
                    ...
                    <div class="agy-enter-btn">
                        <button style="<?= $this->template_styling( 'btn_font_size', 'btn_font_color', 'btn_background_color', '', '', 'btn_border_style', 'btn_border_color' ) ?>"
                                type="button">
                    ...
                    <div class="agy-exit-btn">
                        <a href="<?php echo $this->options_check( 'exit_url' ) ?>">
                            <button style="<?= $this->template_styling( 'exit_btn_font_size', 'exit_btn_font_color', 'exit_btn_background_color', '', '', 'exit_btn_border_style', 'exit_btn_border_color' ) ?>"
