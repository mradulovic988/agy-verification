...
Please make sure to clear the cache and to check Debug mode field. When you finish with the testing, make sure to uncheck that field.

= Can I show the popup only for unregistered user? =

Yes, sure. You need to check the "Show for unregistered user only" field in General page

= Can I use Agy Verification plugin with any theme? =

Yes. The plugin is fully compatible with every WordPress theme.

= Why I can't see the popup? =

Your theme is overwrite the styling of the popup. Please go to the Design page and increase the Z-index values to 9999
